                ...
                <li class="nav-item">
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item" href="{{ url('parent/profile') }}"><i
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            @if (Auth::user()->usertype == 'parent')
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href=""
                                            class="nav-link ml-3 text-light {{ Request::is('parent/transkrip') ?: '' }}">
                                    ...
                                    <li class="nav-item">
                                        <a href=""
                                            class="nav-link ml-3 text-light {{ Request::is('parent/jadwal') ? 'active' : '' }}">
                                    ...
                                    <li class="nav-item">
                                        <a href=""
                                            class="nav-link ml-3 text-light {{ Request::is('parent/presensi') ? 'active' : '' }}">
